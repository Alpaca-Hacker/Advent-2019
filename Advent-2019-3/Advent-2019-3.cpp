// Advent-2019-3.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
int main()
{
	...
	for (int i = 0; i < 301; i++)
	{
		...
		for (int j = 0; j < amount; j++)
		{
			...
			if (WirePath[Wire1Pos] == 0)
			{
				WirePath[Wire1Pos] = steps;
			};
		}
	}
	...
	for (int i = 0; i < 301; ++i)
	{
		...
		for (int j = 0; j < amount; ++j)
		{
			...
			steps++;
			if (WirePath[Wire2Pos] != 0)
			{
				std::cout << "Wires cross at " << Wire2Pos.first << "," << Wire2Pos.second << 
					"["<< WirePath[Wire2Pos] << "]["<< steps <<"]["<< WirePath[Wire2Pos] + steps << "]" << std::endl;
