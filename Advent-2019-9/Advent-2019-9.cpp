...
long long runCode(long long Input[])
{
	...
	while (Input[Ip] != 99)
	{
		...
		long long Arg2 = {};
		long long Arg3 = {};
		getArg(Instruction, Arg1, Arg2, Arg3, Input, Ip, Relative);
...
void getArg(int instruction[5], long long& Arg1, long long& Arg2, long long& Arg3, long long* Input, int Ip, long long Rel)
{
	if (instruction[2] == 0) {
